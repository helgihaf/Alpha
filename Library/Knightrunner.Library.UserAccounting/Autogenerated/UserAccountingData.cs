...
namespace Knightrunner.Library.UserAccounting
{
    ...
    partial void OnExpireDateChanged();
		...
		[Association(Name="PaymentMethod_UserAccount", Storage="_PaymentMethods", ThisKey="Id", OtherKey="AccountId")]
    ...
    partial void OnPriorityChanged();
		...
		[Association(Name="PaymentMethod_UserAccount", Storage="_UserAccounts", ThisKey="AccountId", OtherKey="Id", IsForeignKey=true)]
