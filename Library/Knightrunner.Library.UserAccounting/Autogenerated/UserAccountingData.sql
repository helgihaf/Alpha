...
-- Generated at 2010-09-15T10:52:51
...
ALTER TABLE [dbo].[PaymentMethods] ADD CONSTRAINT [PaymentMethods_PK] PRIMARY KEY CLUSTERED
([Id]);
...
ALTER TABLE [dbo].[PaymentMethods] WITH CHECK ADD CONSTRAINT [PaymentMethods_FK_UserAccounts_AccountId] FOREIGN KEY
