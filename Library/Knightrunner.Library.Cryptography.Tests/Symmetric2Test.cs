...
namespace Knightrunner.Library.Cryptography.Tests
{
    ...
    public class Symmetric2Test
    {
        ...
        public void EncryptDataTest()
        {
            ...
            byte[] encrypted = Symmetric2.EncryptData(data, mainSecretKey);
            byte[] actual = Symmetric2.DecryptData(encrypted, mainSecretKey);
            ...
            encrypted = Symmetric2.EncryptData(data, mainSecretKey);
            actual = Symmetric2.DecryptData(encrypted, mainSecretKey);
            AssertBytesAreEqual(data, actual);
