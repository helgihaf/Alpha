...
namespace Knightrunner.WorkTrack.UI
{
    public static class ComboUtils
    {
            ...
            where T : IConvertible
        {
            ...
            foreach (T value in Enum.GetValues(type))
            {
                ...
                if (predicate == null || predicate(value))
                {
                    ...
                    {
                        text = DatabaseUtilities.EnumResourceString(resourceManager, type, intValue);
                    }
                    if (text == null)
                    {
                    ...
                    comboBox.Items.Add
                    (
                        new DataSelector { Object = intValue, Text = text }
                    );
                }
            }
        }
        ...
        public static void SetComboSelection(ComboBox comboBox, int value)
        {
            ...
            {
                if ((int)((DataSelector)comboBox.Items[i]).Object == value)
                {
        ...
        public static int GetComboSelectionInt(ComboBox comboBox)
        {
            ...
            {
                result = (int)dataSelector.Object;
            }
        ...
        public static void SetComboSelectionNullableInt(ComboBox comboBox, int? value)
        {
            ...
            for (int i = 0; i < comboBox.Items.Count; i++)
            {
                if ((int)((DataSelector)comboBox.Items[i]).Object == actualValue)
                {
                    comboBox.SelectedIndex = i;
                    break;
                }
        ...
        public static void SetComboSelectionNullableGuid(ComboBox comboBox, Guid? value)
        {
            ...
            for (int i = 0; i < comboBox.Items.Count; i++)
            {
                if (((DataSelector)comboBox.Items[i]).Id == actualValue)
                {
                    comboBox.SelectedIndex = i;
                    break;
                }
