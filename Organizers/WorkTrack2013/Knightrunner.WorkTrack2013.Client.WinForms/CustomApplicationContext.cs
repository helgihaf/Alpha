...
namespace Knightrunner.WorkTrack2013.Client.WinForms
{
    public class CustomApplicationContext : ApplicationContext
    {
        ...
        private WorkTrackService.WorkTrackClient workTrackService;
        ...
        public CustomApplicationContext()
        {
            ...
            workTrackService = new WorkTrackService.WorkTrackClient();
